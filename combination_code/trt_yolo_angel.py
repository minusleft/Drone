...
def loop_and_detect(cam, trt_yolo, conf_th, vis):
    ...
    while True:
        ...
        if cls_name == "person":
            ...
            if actual_horizontal_angel < 0:
                trun = -1
            abs_actual_horizontal_angel = abs(actual_horizontal_angel)
            condition_yaw(int(abs_actual_horizontal_angel), 1, trun)
            print("Relative angle =", actual_horizontal_angel) 
